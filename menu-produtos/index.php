...
<body>
    ...
    <main>
        <div class="produtos">
            ...
            function displayProducts($result, $title) {
                if ($result->num_rows > 0) {
                    echo "<h2>$title</h2>";
            ...
            displayProducts($result_vestidos, "Vestidos");
            displayProducts($result_modaintima, "Moda Íntima");
            displayProducts($result_shorts, "Shorts");
            displayProducts($result_camisetas, "Camisetas");
            ?>
        </div>
    </main>
    <footer id="footer"></footer>
